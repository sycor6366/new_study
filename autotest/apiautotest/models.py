...
class HttpApi(models.Model):
    ...
    requestHeader = models.TextField(max_length=10240,verbose_name='请求header',blank=True,null=True)
    requestBody = models.TextField(max_length=10240,verbose_name='请求体',blank=True,null=True)
