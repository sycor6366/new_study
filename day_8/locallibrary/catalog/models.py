...
class MyModelName(models.Model):
    ...
    def get_absolute_url(self):
        ...
        """
        return reverse('model-detail-view',arges = [str(self.id)])
...
class Language(models.Model):
    """
    Model representing a Language (e.g. English,French , Japanses,,etc.)
    """
    name = models.CharField(max_length=200,help_text="Enter a the book's natural language (e.g. English,French,Japanese, etc.)")

    def __str__(self):
        """
        String for reprresenting the Model object (in Admin site etc.)
        """
        return self.name